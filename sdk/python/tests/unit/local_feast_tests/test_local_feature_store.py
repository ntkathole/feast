...
def test_apply_batch_source(test_feature_store, simple_dataset_1) -> None:
    ...
    with prep_file_source(df=simple_dataset_1, timestamp_field="ts_1") as file_source:
        ...
        # Verify timestamps are preserved during apply/registry operations
        applied_source = ds[0]
        ...
        assert roundtrip_source.last_updated_timestamp == original_updated
...
def test_apply_stream_source(test_feature_store, simple_dataset_1) -> None:
    ...
    with prep_file_source(df=simple_dataset_1, timestamp_field="ts_1") as file_source:
        ...
        # Verify timestamps are preserved for both sources
        ...
        # Verify timestamps are included in protobuf representation for stream source
        ...
        # Verify timestamps are included in protobuf representation for file source
