...
class OpenLineageConfig:
    ...
    Attributes:
        ...
        emit_on_retrieval: Emit lineage events during feature retrieval
    ...
    def from_dict(cls, config_dict: Dict[str, Any]) -> "OpenLineageConfig":
        ...
        return cls(
            ...
            emit_on_retrieval=config_dict.get("emit_on_retrieval", True),
    ...
    def from_env(cls) -> "OpenLineageConfig":
        ...
        return cls(
            ...
            == "true",
            emit_on_retrieval=os.getenv(
                "FEAST_OPENLINEAGE_EMIT_ON_RETRIEVAL", "true"
            ).lower()
            == "true",
        )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "emit_on_retrieval": self.emit_on_retrieval,
