...
```bash
pip install feast            # Install Feast
feast init my_feature_repo   # Create a new feature repository
cd my_feature_repo/feature_repo
feast apply                  # Register features and set up your store
feast ui                     # Explore in the web UI
```
...
make install-python-dependencies-dev   # Install all dev dependencies
make test-python-unit                  # Run unit tests
make lint-python                       # Run linters
```
